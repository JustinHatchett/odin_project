...
function game() {
    ...
    if (win >= 3) {
        ...
        console.log("You lost. You won " + win + " out of 5.");
    }
}
game();
// still to do:
...
// [x] Write a NEW function called game(). Use the previous function inside of this one to play a 5 round game that keeps
